...
class _MainNavigationScreenState extends State<MainNavigationScreen> {
      ...
      builder: (context) {
        return Directionality(
          ...
          child: AlertDialog(
            title: Row(
              children: const [
                Icon(Icons.warning_amber_rounded, color: kRose, size: 28),
                SizedBox(width: 8),
            ...
            content: const Text(
              'تنبيه! هل أنت متأكد من مسح جميع بيانات التطبيق والبدء من الصفر؟ '
              'سيؤدي هذا الإجراء لحذف المدرسين، الطلاب، الحصص المجدولة وسجلات الحضور تماماً ولا يمكن الرجوع فيه.',
            ),
            actions: [
              TextButton(
              ...
              ElevatedButton(
                ...
                child: const Text('نعم، صفر كل الداتا',
                    style: TextStyle(
  ...
  Future<void> _clearAllData() async {
    ...
    setState(() {
      ...
      _attendance = [];
      _lockedSessionsToday.clear();
      _selectedAttendanceSessionId = null;
    });
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
        content: Text('تم تصفير كافة بيانات السنتر بنجاح وجاهز للبدء من جديد!'),
